		...
		>
			...
			<div className="container mx-auto px-4 py-8 space-y-12">
				...
				>
					...
					>
						{["栄養バランス計算", "カロリー管理", "食材ロス削減", "時短レシピ"].map(
							(feature, index) => (
								<motion.div
									key={feature}
									initial={{ opacity: 0, x: -20 }}
							...
							<CardContent className="space-y-6">
								...
								<AnimatePresence mode="wait">
									...
									{inputMode === "text" && (
										...
										>
											<div className="relative">
												<motion.div whileFocus={{ scale: 1.02 }} className="flex gap-3">
										...
										<div className="p-4 space-y-3">
											<div>
												<h3 className="font-semibold text-lg">
													{generatedMealPlan.breakfast.name}
												</h3>
											...
											<p className="text-sm text-muted-foreground">
												{generatedMealPlan.breakfast.description}
											</p>
											<div className="flex flex-wrap gap-1">
												{generatedMealPlan.breakfast.ingredients
													.slice(0, 3)
													.map((ingredient, i) => (
								...
								<Card className="group hover:shadow-lg transition-all duration-300 border-0 shadow-md">
									<CardContent className="p-0">
										...
										<div className="p-4 space-y-3">
											...
											<p className="text-sm text-muted-foreground">
												{generatedMealPlan.lunch.description}
											</p>
											<div className="flex flex-wrap gap-1">
								...
								<Card className="group hover:shadow-lg transition-all duration-300 border-0 shadow-md">
									<CardContent className="p-0">
										...
										<div className="p-4 space-y-3">
											...
											<p className="text-sm text-muted-foreground">
												{generatedMealPlan.dinner.description}
											</p>
											<div className="flex flex-wrap gap-1">
									...
									>
										{[
											...
											<motion.div
												...
												initial={{ opacity: 0, scale: 0.8 }}
												animate={
													featuresInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }
												}
												transition={{ delay: 1 + index * 0.1, duration: 0.6 }}
